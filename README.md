...
<div style="display: inline-block"><div><h2 style="color: #ed9e70"> How to start game </h2>
<p>
In order to run the game, the Main.java class has to be opened and executed.
</p>
<h2 style="color: #ed9e70">Controls</h2>
<p> <li>WASD or arrow keys : move penguin towards desired direction </li>
...
The exit is located at the bottom right of the maze.</p></div>

<div><img src="src/main/resources/img/pgnBig.png" alt="Penguin Run" height="100"></div></div>
